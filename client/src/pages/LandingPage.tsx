...
import { ArrowRight, Shield, Globe, Radio, Users } from "lucide-react";

export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans">
      {/* 1. Header (Dark) */}
      <header className="bg-[#0A0F1E] text-white sticky top-0 z-50 border-b border-white/10">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg tracking-tight">The Global Resilience Hub</span>
          </div>
          
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-300">
            <a href="#news" className="hover:text-white transition-colors">防災ニュース</a>
            <a href="#community" className="hover:text-white transition-colors">コミュニティ</a>
            <a href="#events" className="hover:text-white transition-colors">イベント</a>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-2xl mx-auto leading-relaxed">
              The Global Resilience Hubは、企業・自治体・個人のための<br className="hidden md:block" />
              次世代型防災プラットフォームです。
            </p>
      ...
      <section id="events" className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-10">
            <h2 className="text-2xl md:text-3xl font-bold text-slate-900">近日開催のイベント</h2>
      ...
      <section className="py-16 md:py-24 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-10">
            <h2 className="text-2xl md:text-3xl font-bold text-slate-900">イベントレポート</h2>
            <a href="#" className="text-blue-600 font-medium hover:underline flex items-center gap-1">
              すべて見る <ArrowRight className="w-4 h-4" />
            </a>
          </div>
      ...
      <section id="news" className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-4">お知らせ</h2>
      ...
      <section id="services" className="py-16 md:py-24 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-4">関連サービス</h2>
