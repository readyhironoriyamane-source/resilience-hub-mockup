...
export const contentItems: ContentItem[] = [
  {
    ...
    image: "https://files.manuscdn.com/user_upload_by_module/session_file/92549119/APwdhsHRGLOnpVQd.png",
    category: "ガイドライン・法改正",
...
export const mockArticles = [
  {
    ...
    author: "Resilience Hub Editorial",
    date: "2026年2月1日",
    thumbnail: "https://files.manuscdn.com/user_upload_by_module/session_file/92549119/APwdhsHRGLOnpVQd.png",
    category: "ガイドライン・法改正",
