...
この利用規約（以下「本規約」といいます。）は、株式会社MetaEarthHeroes（以下「当社」といいます。）が提供するサービス「Resilience Hub（レジハブ）」（以下「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆様（以下「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
...
## 第4条（利用料金および支払方法）
1. ユーザーは、本サービスのうち有料部分（GOLD MEMBER等）の対価として、当社が別途定め、本ウェブサイトに表示する利用料金を、当社が指定する方法により支払うものとします。
...
2. **特に、本サービス上で提供される防災・災害情報は、参考情報として提供されるものであり、その正確性、即時性、完全性を保証するものではありません。ユーザーは、自己の責任において当該情報を利用し、生命・身体の安全確保については、公的機関の発表や現場の状況を優先して判断するものとします。**
